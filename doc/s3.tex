...
Posteriormente, el operador $U_f$ computa los resultados de la función $f$ de 
...
%
\begin{equation}
c_k = \frac{1}{2^n} \left((-1)^{z \cdot x} + (-1)^{z \cdot (x \oplus 
s)}\right)
\end{equation}
%
El producto interno $z \cdot (x \oplus s)$ puede descomponerse en $ z \cdot x
\oplus z \cdot s$, y substituyendo
%
\begin{equation}
\begin{split}
c_k & = \frac{1}{2^n} \left((-1)^{z \cdot x} + (-1)^{z \cdot x \oplus 
z \cdot s} \right) \\
	& = \frac{1}{2^n} \left((-1)^{z \cdot x} + (-1)^{z \cdot x}
	(-1)^{z \cdot s} \right)
\end{split}
\end{equation}
%
Cuando $ z \cdot s = 1$, el coeficiente $c_k$ será
%
\begin{equation}
\begin{split}
c_k = \frac{1}{2^n} \left((-1)^{z \cdot x} - (-1)^{z \cdot x} \right) =
	\frac{1}{2^n} (0) = 0
\end{split}
\end{equation}
%
Y cuando $ z \cdot s = 0$, será
%
\begin{equation}
c_k = \frac{1}{2^n} \left((-1)^{z \cdot x} + (-1)^{z \cdot x} \right)
...
$z \cdot s = 0$. Así que sólo los estados de esta forma tendrán coeficientes 
...
\end{equation}
%
Finalmente, tras anular los términos en los que $z \cdot 01 = 1$, es decir 
$z=01$ y $z=11$, queda
%
\begin{equation}
...
la restricción $z \cdot s = 0$. Una vez que se obtengan $n-1$ vectores 
...
posibles resulta $z \in \{00, 10\}$. En todo caso, se tiene que $ z \cdot s = 
0$ de modo que $00 \cdot s = 0$ y $10 \cdot s = 0$, produciendo las 
ecuaciones:
%
\begin{equation}
\begin{split}
...
a un vector $z$ de $n$ bits, con $W = \{z / z \cdot s = 0\}$ y $z \in W$. Los 
